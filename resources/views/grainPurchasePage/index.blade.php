                ...
                @if (isset($pageContent))
                    @foreach($pageContent as $item)
                            <tr>
                                ...
                                <td>
                                <a href="{{ url('/admin/page/grainPurchase/' . $item->id) }}" title="Посмотреть блок"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Просмотр</button></a>
                                    <a href="{{ url('/admin/page/grainPurchase/' . $item->id . '/edit') }}" title="Редактировать блок">
