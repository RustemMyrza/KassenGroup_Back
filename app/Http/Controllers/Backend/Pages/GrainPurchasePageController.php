...
class GrainPurchasePageController extends PageController
{
    protected $modelClass = GrainPurchasePage::class;
    protected $viewName = 'grainPurchasePage';
    protected $redirectUrl = 'admin/page/grainPurchase';
    ...
    {
        return view('grainPurchasePage.create');
    }
