...
class ContactsPageController extends PageController
{
    protected $modelClass = ContactsPage::class;
    protected $viewName = 'contactsPage';
    protected $redirectUrl = 'admin/page/contacts';
    ...
    {
        return view('contactsPage.create');
    }
